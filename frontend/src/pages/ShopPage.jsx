      ...
      <div className='col-span-1 lg:col-span-3'>
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center mb-6">
            <ShoppingCart className="mr-3 text-primary" size={32} />
            <h1 className="text-3xl font-bold text-primary">Our Shop</h1>
          </div>
          ...
          <div className="mb-6 flex space-x-4">
            <div className="flex items-center">
              ...
              <select 
                ...
                className="border rounded px-3 py-2 bg-secondary text-neutral text-sm"
              >
          ...
          {/* Shop Items Grid */}
          {isLoading ? (
            <div className="text-center text-accent-content py-8">Loading shop items...</div>
          ) : error ? (
          ...
          {!isLoading && shopData?.shopItems?.length === 0 && (
            <div className="text-center py-12">
              <ShoppingCart className="mx-auto mb-4 text-accent" size={64} />
              <p className="text-xl text-neutral">No items available in this category</p>
            </div>
          )}
        </div>
      </div>
